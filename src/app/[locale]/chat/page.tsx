...
export default function ChatPage() {
  ...
  const { messages, streaming, modelSlug, chatId, addMessage, appendToAssistant, setStreaming, setModel, setChatId } =
    useChatStore();
  ...
  const send = async (text: string, attachments: Attachment[], webSearch: boolean = false) => {
    ...
    // Auto-routing: picked text-only model but sent an image → swap to vision model
    // and inject a system prompt tailored for photo-to-solution.
