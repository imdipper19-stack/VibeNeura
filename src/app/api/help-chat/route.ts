...
- Доступные модели: GPT-4o, Claude 3.5/4, Gemini 2.0, DeepSeek v3, Llama 3 и другие
...
function getFallbackAnswer(input: string): string {
  ...
  const faq: Array<{ kw: string[]; ru: string; en: string }> = [
    { kw: ['модел', 'model', 'gpt', 'claude'], ru: 'У нас есть GPT-4o, Claude, Gemini, DeepSeek и другие модели 🔥 Выбирайте в селекторе над чатом!', en: 'We have GPT-4o, Claude, Gemini, DeepSeek and more 🔥 Pick in the selector above the chat!' },
